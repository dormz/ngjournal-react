...
namespace NewGenJournal.API.Migrations
{
    ...
    public partial class InitialTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Tenants",
                columns: new[] { "Id", "CreatedAt", "Description", "IsActive", "Name", "Subdomain" },
                values: new object[] { 1, new DateTime(2026, 1, 18, 18, 58, 44, 557, DateTimeKind.Utc).AddTicks(9367), null, true, "Default Tenant", "default" });
